...
class MILOptimizer:
    def __init__(self,
        ...
        self.expert_obs = tf.placeholder(tf.float32, shape=[None, self.policy.ob_dim], name='expert_obs')
        self.expert_actions = tf.placeholder(tf.float32, shape=[None, self.policy.action_dim], name='actions')
